<div id="addUserBankForm"
     data-action="<?php echo e(getAdminPanelUrl("/settings/financial/user_banks/". (!empty($editBank) ? $editBank->id."/update" : 'store'))); ?>">

    <?php if(!empty(getGeneralSettings('content_translate'))): ?>
        <div class="form-group">
            <label class="input-label"><?php echo e(trans('auth.language')); ?></label>
            <select name="locale" class="form-control <?php echo e(!empty($editBank) ? 'js-user-banks-locale' : ''); ?>">
...
<?php /**PATH /home/dh_qnb2zj/masar-edu.online/resources/views/admin/settings/financial/user_banks/modal.blade.php ENDPATH**/ ?>